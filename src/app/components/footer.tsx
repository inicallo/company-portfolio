    ...
    <div className="bg-secondary">
      <div className="w-full lg:pl-28">
        <footer className="footer text-base-content content-center pb-1 p-10">
          ...
          <nav>
            <h6 className="footer-title text-slate-200">Company</h6>
            <a href="/about-us" className="link link-hover text-slate-300">
              About us
            </a>
            <a href="/contact-us" className="link link-hover text-slate-300">
              Contact
            </a>
            <a href="/blog" className="link link-hover text-slate-300">
              Blog
            </a>
            <a href="/team" className="link link-hover text-slate-300">
              Our Team
            </a>
          </nav>
          <nav>
            <h6 className="footer-title text-slate-200">Legal</h6>
          ...
          <form>
            <h6 className="footer-title text-slate-200">Newsletter</h6>
            <fieldset className="form-control w-80">
              ...
              <div className="join">
                <input
                  ...
                  className="border-none join-item w-44 lg:w-auto"
                  required
                />
                <button className="btn btn_dark_red join-item">
                  Subscribe
                </button>
              </div>
            </fieldset>
        ...
        <div className="flex text-base-content content-center justify-center mt-6 lg:mt-0 p-1 lg:pr-40">
          ...
          {/* Github */}
          <a
            href="https://github.com/inicallo"
            target="_blank"
            className="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-300 text-slate-300 hover:border-primary hover:bg-primary hover:text-white"
          >
            <svg
          ...
          {/* Behance */}
          <a
            href="https://www.behance.net/calvinangelo"
            target="_blank"
            className="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-300 text-slate-300 hover:border-primary hover:bg-primary hover:text-white"
          >
            <svg
