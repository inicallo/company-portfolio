      ...
      <div className="container">
        ...
        <div className="flex flex-wrap px-4">
          <div className="w-full self-center lg:pt-5 px-4 lg:w-1/2 mb-16">
            <h4 className="font-semibold text-center text-lg text-primary mb-2 uppercase lg:text-xl">
              CAStudio
            </h4>
            <p className="font-medium text-justify m-5 text-md text-slate-600 md:text-lg">
              ...
              product, and real estate needs.
              <br />
              <br />
              Our commitment to consistent quality is underscored by our
              dedicated team of editors, who enhance each project to align
              perfectly with your brand, style, and personality. Whether
              you&apos;re an SME, SMB, or enterprise, CAStudio provides
              tailored, local expertise without the need for travel.
              <br />
              <br />
              Though we are a new company, our global reach and dedication to
              excellence position us as a trusted partner for all your visual
              content needs.
            </p>
