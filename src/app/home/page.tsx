...
const Hero = () => {
  ...
  return (
    <section className="relative flex items-center justify-center min-h-screen">
      ...
      {/* Content */}
      <div className="absolute lg:mt-72 mt-20 text-center inset-0 flex flex-col justify-center items-center p-8 md:p-12 lg:p-20 lg:items-start lg:text-left lg:justify-center z-20">
        ...
        <div className="flex flex-col items-center justify-end h-full w-full mb-14 lg:flex-row-reverse lg:mb-80">
