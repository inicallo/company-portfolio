  ...
  return (
    <section className="relative mt-5 flex items-center justify-center min-h-screen pt-16">
      <div className="relative h-screen w-full overflow-hidden">
        ...
        {/* Shadow Layer */}
        <div className="absolute inset-0 bg-gradient-to-b from-white to-transparent opacity-60 md:bg-gradient-to-r md:from-white md:to-transparent" />
      </div>

      {/* Content */}
      <div className="absolute lg:mt-48 mt-16 text-center inset-0 flex flex-col justify-center items-center p-8 md:p-12 lg:p-20 lg:items-start lg:text-left lg:justify-center z-20">
          ...
          <p className="text-[12px] md:text-lg lg:text-xl italic text-gray-800 mb-5 text-center lg:text-left">
          Get tailored photography and video services<br />
          anywhere in the world with our network of local experts,<br/ > ensuring top-quality visuals every time
          </p>
