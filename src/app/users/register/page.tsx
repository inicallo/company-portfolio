...
const Register: React.FC = () => {
  ...
  const handleSubmit = (event: React.FormEvent) => {
    ...
    // Basic validation
    if (!email || !password || !repeatPassword || !firstName || !lastName || !phone || !company || password !== repeatPassword) {
      setIsValid(false);
      return;
    }
  ...
  return (
    <section className="relative pt-20 pb-24 bg-slate-100">
        ...
        <div className="container">
          ...
          <form className="max-w-md mx-auto" onSubmit={handleSubmit}>
            ...
            <div className="relative z-0 w-full mb-5 group">
              ...
              {!isValid && password !== repeatPassword && <p className="text-red-500 text-sm">Passwords do not match</p>}
            </div>
