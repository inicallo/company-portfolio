...
export const metadata: Metadata = {
  ...
  description:
    "Get in touch with CA Studio for inquiries, bookings, or support. We're here to assist you with all your photography needs.",
};
        ...
        <div className="container">
          <div className="w-full px-4 lg:m-5 lg:mb-10 lg:mt-28">
            <div className="max-w-full mx-auto text-center mb-3 w-full lg:w-1/2">
              <h4 className="font-bold bg-gradient-to-br mt-10 text-dark1 text-2xl mb-3 max-w-xl md:font-bold lg:text-4xl">
                Ready to bring your visual content to life?
              </h4>
            </div>
          </div>
          {/* --team start-- */}
            ...
            <div className="w-full lg:w-2/3 lg:mx-auto">
              <div className="w-full px-4 mb-8">
                ...
                >
                  ...
                  <option>Interior & Architectural</option>
                  <option>Headshot & Company Profile</option>
                  <option>Videography & TVC</option>
